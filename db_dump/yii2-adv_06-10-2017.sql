...
INSERT INTO `product` (`id`, `name`, `category_id`, `description`, `price`, `meta_title`, `meta_description`, `sale`, `image`) VALUES
(1,	'Туфли',	NULL,	'fsdfsdfsdf',	234,	'',	'',	1,	NULL);
